...
if (!isRealEmbeddingIntegrationEnabled()) {
  describe.skip("VoyageEmbeddingProvider real integration", () => {
    it("requires RUN_REAL_EMBEDDING_INTEGRATION_TESTS=true", () => {
      expect(true).toBe(true);
    });
  });
} else {
  describe("VoyageEmbeddingProvider real integration", () => {
    it("generates document and query embeddings against the real Voyage API", async () => {
